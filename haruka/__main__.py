...
from SoulQueen.modules import ALL_MODULES
from SoulQueen.modules.helper_funcs.alternate import typing_action
from SoulQueen.modules.helper_funcs.chat_status import is_user_admin
from SoulQueen.modules.helper_funcs.misc import paginate_modules
from SoulQueen.modules.helper_funcs.readable_time import get_readable_time
...
buttons = [
    [
        InlineKeyboardButton(text="📌Updates Channel", url="https://t.me/PegasusUpdates"),
        InlineKeyboardButton(text="🖲 Support Group", url="https://t.me/UnitedSupport"),
    ],
    [
        InlineKeyboardButton(text="Owner", url="https://t.me/cRaZyBoY_420"),
        InlineKeyboardButton(text="❔ Help", callback_data="help_back"),
    ],
    [
        InlineKeyboardButton(
            text="➕ Add NOBISUKI To Youre Group ➕", url="t.me/Nobisukibot?startgroup=true"
        ),
    ],
]
...
Support them  [Crazy Boy](t.me/cRaZyBoY_420)"""
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("SoulQueen.modules." + module_name)
...
@run_async
def SoulQueen_about_callback(update, context):
    query = update.callback_query
    if query.data == "aboutmanu_":
        query.message.edit_text(
            ...
            f"\n\n Join [NobisukiUpdates](https://t.me/NobisukiUpdates) To Keep Yourself Updated About {dispatcher.bot.first_name}"
        ...
        query.message.edit_text(
            ...
            f"\n\nYou Can get support {dispatcher.bot.first_name} by joining [Anki Vectr Support](https://t.me/Nobisuki_Official).\n"
            f"",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
